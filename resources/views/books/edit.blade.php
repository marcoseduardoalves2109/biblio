        ...
        <div class="col-md-12">
            <div class="panel panel-default">
            	<ol class="breadcrumb panel-heading">
                	<li><a href="{{route('book.index')}}">Produtos</a></li>
                ...
                <div class="panel-body">
	                <form action="{{ route('book.update', $book->id) }}" method="POST" enctype="multipart/form-data">
						...
						<div class="form-group">
						    ...
						    <input type="text" class="form-control" name="title" id="title" placeholder="Título" value="{{ $book->name }}">
						</div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <img src="http://192.168.22.10/laravel/public/images/book/{{ $image->image }}"  width="10%" />
                            @endforeach
                        </div>
